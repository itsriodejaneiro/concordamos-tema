...
function custom_menus() {
    register_nav_menu('main-menu', __('Menu Principal', 'concordamos-textdomain'));
    /* register_nav_menu('footer-menu', __('Menu de Rodapé', 'concordamos-textdomain')); */

    register_nav_menu('social-networks', __('Redes Sociais', 'concordamos-textdomain'));
    register_nav_menu('footer-menu-first', __('Menu de Rodapé 1', 'concordamos-textdomain'));
    register_nav_menu('footer-menu-second', __('Menu de Rodapé 2', 'concordamos-textdomain'));
    register_nav_menu('footer-menu-third', __('Menu de Rodapé 3', 'concordamos-textdomain'));
    register_nav_menu('footer-menu-fourth', __('Menu de Rodapé 4', 'concordamos-textdomain'));
}
